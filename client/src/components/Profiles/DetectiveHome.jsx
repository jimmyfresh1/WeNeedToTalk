...
import { detectiveData } from "./ProfilePageComponents/characterData";
const DetectiveHome = () => {
  const {
    alias,
    realName,
  ...
  return (
    <motion.div
      ...
      variants={Variants}
      id="chatscroll"
      className="detective-home chatmain char-home"
      id="chatscroll"
    >
      <div className="bio">
        <h3>Alias: {alias}</h3>
      ...
      <div className="bottom-half bottom-half-detective">
        <div className="blurb detective-blurb">
