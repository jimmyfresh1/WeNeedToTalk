...
import { socratesData } from "./ProfilePageComponents/characterData";
const SocratesHome = () => {
  const {
    alias,
    realName,
  ...
  return (
    <motion.div
      ...
      variants={Variants}
      id="chatscroll"
      className="socrates-home chatmain char-home"
      id="chatscroll"
    >
      <div className="bio">
        <h3>Alias: {alias}</h3>
      ...
      <div className="bottom-half bottom-half-socrates">
        <div className="blurb ">
        ...
        <div className="convo-choose" id="socrates-choose">
